...
public class BrokenElderKey {
    ...
    public static ItemStack getKey() {
        ...
        meta.displayName(ComponentUtils.component("Сломанный древний ключ", TextColor.color(214, 144, 0)));
        key.setItemMeta(meta);
        key = NBT.addNBT(key, "type", "broken_elder_key");
        return key;
    }
