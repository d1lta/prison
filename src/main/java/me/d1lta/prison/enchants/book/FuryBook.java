...
public class FuryBook extends EnchantmentBook {
    ...
    public FuryBook(int lvl, int chance) {
        super(Enchantments.FURY, lvl, chance, List.of(
                ...
                ComponentUtils.component("тебя злым как чёрт. Злая чарка.", TextColor.color(255, 196, 129)),
                ComponentUtils.component("- - - - - - - - - - - - - - - - -", TextColor.color(129, 129, 122))
        ), applicableTo);
    }
